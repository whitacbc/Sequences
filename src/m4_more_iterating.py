...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 5
    actual = count_positive_sines([4,5,67,3,2,1,3,456,3])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 65
    actual = sum_first_n([44, -34, 55, 7], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 168
    actual = sum_first_n([33, 46, 80, 9], 4)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
