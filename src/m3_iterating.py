...
def run_test_count_negatives():
    ...
    # Test 6:
    expected = 2
    actual = count_negatives((8, 13, -40, -5))
    print()
    ...
    # Test 7:
    expected = 3
    actual = count_negatives((8, 13, 7, -5,-5,-5,5))
    print()
...
def run_test_count_short_ones():
    ...
    # Test 9:
    expected = 3
    seq = [[1, 8,8, 1], [88881, 12], [1, 1], [111111111111]]
    actual = count_short_ones(seq)
    print()
